...
digraph G {
  graph [layout = dot]
  node [shape = box, style = filled, margin=0.1, height=0.1, fontname='Helvetica']
  edge [fontname='Courier']

  subgraph cluster1 { 
    node [fillcolor = pink1]
    co1 [label = 'term2term-pair \n(ngram)']
    co2 [label = 'term-term-count']
    co3 [label = 'term-term-matrix']
    co1 -> co2 -> co3
    label = 'ngram'
    color='dimgrey'
  }
  ...
  corpus [label = 'Corpus (text)', fillcolor=skyblue]
  corpus -> b1[label='tokenization()\n unnest()']
  b1 [label = 'doc-term-list', fillcolor = Beige]
  b1 -> co1
  viz1 [label = 'plot()', fillcolor = gold1]
  co3 -> {dr1, dr2} -> viz1
}
")
```
